...
const target = `console.log("[PROFILE FETCH] checkActiveSession: skipping immediate fetch (deferred)");
                    let profileData = null;`;

const replacement = `console.log("[PROFILE FETCH] checkActiveSession: fetching fresh profile");
...
if (content.includes(target)) {
    ...
    console.log("Successfully restored profile fetch in checkActiveSession.");
} else {
