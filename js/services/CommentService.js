...
export class CommentService {
    ...
    static renderCommentCountButton(contentType, contentId) {
        ...
        return `
            <button class="comment-count-btn flex items-center justify-center gap-1.5 px-2.5 py-1 sm:px-3 sm:py-1 rounded-[8px] bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/10 text-[10.5px] sm:text-[11px] font-bold text-slate-600 dark:text-dark-textSecondary hover:bg-slate-100 dark:hover:bg-white/10 transition-colors shrink-0 whitespace-nowrap" 
