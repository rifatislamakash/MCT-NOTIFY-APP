...
window.updateTodayAtGlanceCounters = function() {
    try {
        ...
        const items = [
            ...
            { id: 'classes', label: 'Classes', count: classesCount, priority: 2, icon: '<div class="shrink-0 flex items-center justify-center" style="width: 20px; height: 20px;"><i data-lucide="book-open" class="w-full h-full text-indigo-500"></i></div>', color: 'text-indigo-500', action: "navigate('screen-weekly-routine'); loadWeeklyRoutine();" },
            { id: 'notices', label: 'Notices', count: noticesCount, priority: 3, icon: '<div class="shrink-0 flex items-center justify-center" style="width: 20px; height: 20px;"><i data-lucide="megaphone" class="w-full h-full text-red-500"></i></div>', color: 'text-red-500', action: "navigate('screen-notices-list'); loadNotices();" },
            { id: 'assignments', label: 'Assignments', count: assignmentsCount, priority: 4, icon: '<div class="shrink-0 flex items-center justify-center" style="width: 22px; height: 22px;"><i data-lucide="clipboard-list" class="w-full h-full text-purple-500"></i></div>', color: 'text-purple-500', action: "navigate('screen-weekly-routine');" },
            { id: 'presentations', label: 'Presentation', count: presentationsCount, priority: 5, icon: '<div class="shrink-0 flex items-center justify-center" style="width: 22px; height: 22px;"><i data-lucide="monitor-play" class="w-full h-full text-pink-500"></i></div>', color: 'text-pink-500', action: "navigate('screen-weekly-routine');" }
        ];
